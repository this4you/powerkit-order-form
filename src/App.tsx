        ...
        <div className="app">
            ...
            <Box sx={{ marginBottom: '20px' }} className="form-container">
                ...
                <AppForm submit={createOrder} formValidator={new OrderFormValidator()}>
                    ...
                    <FormTextField sx={inputStyle} id="additionalInfo" name="additionalInfo" label="Додаткова інформація" variant="standard"/>
                    ...
                    <Button type="submit" sx={{ marginTop: '15px', marginBottom: '15px', width: '80%' }} variant="contained">
                        Замовити
                    </Button>
                </AppForm>
            </Box>
